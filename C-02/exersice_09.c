...
//	printf("Год %d %s!\n", year, markerYearVis ? "високосный" : "не високосный");
//
//	marker_y = (year >= 0 ? 1 : 0);
//
...
//		(day >= 1 && day <= 30) ? 1 :
//		(month == 2 && markerYearVis == 1) && (day >= 1 && day <= 29)) ? 1 :
//		((month == 2) && (day >= 1 && day <= 28)) ? 1 : 0;
//		
...
//		(month == 4 || month == 6 || month == 9 || month == 11) &&
//		(day == 30) ? 1 :
//		(month == 2 && markerYearVis == 1) && (day == 29)) ? 1 : 
//		((month == 2) && (day == 28) && markerYearVis == 1) ? day + 1 : 
//		(month == 2) && (day == 28) ? 1 : day + 1;
//
//	// вычисление месяца в зависимости от значения дня
//	monthNext = (dayNext != 1 ? month :
//		dayNext == 1 && (month + 1) < 13 ? month + 1 : 1);
